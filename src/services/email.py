                            ...
                            if sender:
                                ...
                                if email_addr and "@" in email_addr:
                                    ...
                                    if email_addr not in subscribers:
                                        ...
                                        self._send_reply(
                                            email_addr,
                                            "Subscribed to Horizon Brief",
                                            "You have been successfully subscribed to Horizon Brief daily summaries.",
                                        )
                            ...
                            if sender:
                                ...
                                if email_addr and "@" in email_addr:
                                    ...
                                    if email_addr in subscribers:
                                        ...
                                        self._send_reply(
                                            email_addr,
                                            "Unsubscribed from Horizon Brief",
                                            "You have been successfully unsubscribed from Horizon Brief daily summaries.",
                                        )
