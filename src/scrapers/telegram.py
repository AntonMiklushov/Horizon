...
USER_AGENT = "Mozilla/5.0 (compatible; HorizonBrief/1.0; +https://github.com/AntonMiklushov/Horizon)"
...
class TelegramScraper(BaseScraper):
    ...
    def _parse_message(
        ...
        return ContentItem(
            ...
            metadata={"msg_url": msg_url, "discovery_url": msg_url, "channel": channel},
        )
